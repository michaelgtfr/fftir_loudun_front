<template>
  ...
  <div v-if="showPresentation" class="row home-presentation">
    <p class="home-presentation__text col-lg-8 offset-lg-2 mt-5 mb-5">
      {{ getpersonalizedContent('presentation') }}
    </p>
  </div>

  <!--Presentation of discipline-->
  <div v-if="showDisciplines" class="discipline-presentation row p-4">
    <h2 class="col-lg-12 text-center">Exemple de disciplines praticables</h2>
    <div class="col-lg-12 p-4">
      <ul class="d-flex justify-content-around">
        <li v-for="(discipline, index) in disciplines" :key="index">
          <button
            :class="dynamiqueStyleOfDisciplineLink(discipline.id)"
            class="btn discipline-presentation__btn"
    ...
    <div class="discipline-presentation__img col-lg-4">
      <img class="col-lg-12" :src="urlDisciplineImg" alt="image of discipline" />
    </div>
    <div class="m-2 discipline-presentation__content col-lg-4">
      <p class="col-lg-12">{{ disciplineSelected.presentation }}</p>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-5 offset-1 text-center p-4">
          ...
          <div class="card-presentation__block-text">
            ...
            <p>
              Stand de tir exterieur sur la commune de Saint-Leger, pas de tir allant jusqu'à 75m,
              calibre jusqu'au 7.62 ou équivalent.
            </p>
          </div>
        ...
        <div class="col-lg-5 text-center p-4">
          ...
          <div class="card-presentation__block-text">
            ...
            <p>
              Stand de tir interieur sur Loudun. pas de tir 10m, au plomb, carabine et arme de
              poing.
            </p>
          </div>
          <a href="#" class="btn mt-4">Voir plus d'information</a>
...
export default {
  ...
  computed: {
     ...
     */
    urlDisciplineImg() {
      return `${import.meta.env.VITE_BASE_IMG_URL}/uploads/disciplineImg/${
        this.disciplineSelected.disciplinePicture
      }`
    }
  },
  methods: {
    ...
    getShowsShootingsDisciplines() {
      axios.get(`${import.meta.env.VITE_API_URL}/showsShootingsDisciplines`).then((response) => {
